module CHAOS.Portal.Client
{
    ...
    {
		public static Get(guid : string = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
    	{
		...
		public static Create(name: string, schemaXml: string, guid: string = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
           if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Update(name: string, schemaXml: string, guid: string, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
           if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Delete(guid: string, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
           if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static HasPermissionToMetadataSchema(guid: string, permission: number, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
           if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	export class Folder
	{
		public static GetPermission(folderID : number, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static SetPermission(userGuid: string, groupGuid: string, folderID: number, permission:number, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Get(id: number = null, folderTypeID: number = null, parentID: number = null, permission:number = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
    	{
			if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Delete(id: number, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Update(id: number, newTitle: string, newParentID: number = null, newFolderTypeID: number = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Create(subscriptionGuid: string, title: string, parentID: number = null, folderTypeID: number = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	{
		public static Get(name: string = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
    	{
			if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	{
		public static Get(name: string = null, languageCode: string = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
    	{
			if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	export class Link
	{
		public static Create(objectGuid: string, folderID: number, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Update(objectGuid: string, folderID: number, newFolderID:number, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Delete(objectGuid: string, folderID: number, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	export class Object
	{
		public static Create(guid: string, objectTypeID: number, folderID: number, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static SetPublishSettings(objectGuid: string, accessPointGuid: string, startDate: Date, endDate: Date, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	{
		public static Set(object1Guid: string, object2Guid: string, objectRelationTypeID: number, sequence: number = null, metadataGuid: string = null, metadataSchemaGuid: string = null, languageCode: string = null, metadataXml : string = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Delete(object1Guid: string, object2Guid: string, objectRelationTypeID: number, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	{
		public static Get(value: string = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
    	{
			if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	{
		public static Set(objectGuid: string, metadataSchemaGuid: string, languageCode: string, revisionID: number, metadataXml: string, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
    	{
			if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	{
		public static Get(serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
    	{
			if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Set(name: string, id: number = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
    	{
			if(serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	{
		public static GetUserFolder(userGuid: string = null, createIfMissing: boolean = true, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
		{
			if (serviceCaller == null)
				serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static GetUserObject(userGuid: string = null, createIfMissing: boolean = true, includeMetata: boolean = false, includeFiles: boolean = false, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
	    {
	        if (serviceCaller == null)
	            serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
	...
	{
		public static Get(metadataSchemaGuid: string, userGuid: string = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
	    {
	        if (serviceCaller == null)
	            serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
		...
		public static Set(metadataSchemaGuid: string, metadata: string, userGuid: string = null, serviceCaller: CHAOS.Portal.Client.IServiceCaller = null): ICallState<IPagedPortalResult<any>>
	    {
	        if (serviceCaller == null)
	            serviceCaller = CHAOS.Portal.Client.ServiceCallerService.GetDefaultCaller();
